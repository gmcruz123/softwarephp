...
$nonAdminTablesArr[] = "docente";
$nonAdminTablesArr[] = "estado";
$nonAdminTablesArr[] = "asignatura";
$nonAdminTablesArr[] = "profesion";
$nonAdminTablesArr[] = "estudiantes";
$nonAdminTablesArr[] = "habilidades";
$nonAdminTablesArr[] = "Reporte de Estudiantes";
$nonAdminTablesArr[] = "usuarios";
$nonAdminTablesArr[] = "roles";
$nonAdminTablesArr[] = "Quienes Somos";
$nonAdminTablesArr[] = "PROYECTOS";
$nonAdminTablesArr[] = "PIAR";
$nonAdminTablesArr[] = "PERFILDOCENTE";
$nonAdminTablesArr[] = "ESTUDIANTESACARGO";
$nonAdminTablesArr[] = "Estadisticas de Estudiantes";
$nonAdminTablesArr[] = "miscasos";
$nonAdminTablesArr[] = "seguimiento";
$nonAdminTablesArr[] = "preguntas";
$nonAdminTablesArr[] = "rangocalificacion";
$nonAdminTablesArr[] = "Dicccionario";
...
$wGroupTableName = $ug_connection->addTableWrappers( "lasierra_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "lasierra_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "lasierra_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "lasierra_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "lasierra_ugmembers" );
