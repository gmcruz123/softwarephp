...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "lasierra_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "asignatura", "varname" => "lasierra_at_localhost__asignatura", "altvarname" => "asignatura", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "docente", "varname" => "lasierra_at_localhost__docente", "altvarname" => "docente", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "estado", "varname" => "lasierra_at_localhost__estado", "altvarname" => "estado", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "estudiantes", "varname" => "lasierra_at_localhost__estudiantes", "altvarname" => "estudiantes", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "habilidades", "varname" => "lasierra_at_localhost__habilidades", "altvarname" => "habilidades", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "lasierra_uggroups", "varname" => "lasierra_at_localhost__lasierra_uggroups", "altvarname" => "lasierra_uggroups", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "lasierra_ugmembers", "varname" => "lasierra_at_localhost__lasierra_ugmembers", "altvarname" => "lasierra_ugmembers", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "lasierra_ugrights", "varname" => "lasierra_at_localhost__lasierra_ugrights", "altvarname" => "lasierra_ugrights", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "miscasos", "varname" => "lasierra_at_localhost__miscasos", "altvarname" => "miscasos", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "preguntas", "varname" => "lasierra_at_localhost__preguntas", "altvarname" => "preguntas", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "profesion", "varname" => "lasierra_at_localhost__profesion", "altvarname" => "profesion", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "RANGOCALIFICACION", "varname" => "lasierra_at_localhost__RANGOCALIFICACION", "altvarname" => "RANGOCALIFICACION", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "roles", "varname" => "lasierra_at_localhost__roles", "altvarname" => "roles", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "seguimiento", "varname" => "lasierra_at_localhost__seguimiento", "altvarname" => "seguimiento", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
			$dalTables[$conn->connId][] = array("name" => "usuarios", "varname" => "lasierra_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "lasierra_at_localhost", "schema" => "", "connName" => "lasierra at localhost");
		}
	}
