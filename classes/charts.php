...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("docente" == $this->chrt_array['tables'][0])
			return true;
		if("estado" == $this->chrt_array['tables'][0])
			return true;
		if("asignatura" == $this->chrt_array['tables'][0])
			return true;
		if("profesion" == $this->chrt_array['tables'][0])
			return true;
		if("estudiantes" == $this->chrt_array['tables'][0])
			return true;
		if("habilidades" == $this->chrt_array['tables'][0])
			return true;
		if("estudiantes" == $this->chrt_array['tables'][0])
			return true;
		if("usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("roles" == $this->chrt_array['tables'][0])
			return true;
		...
		if("estudiantes" == $this->chrt_array['tables'][0])
			return true;
		if("miscasos" == $this->chrt_array['tables'][0])
			return true;
		if("seguimiento" == $this->chrt_array['tables'][0])
			return true;
		if("preguntas" == $this->chrt_array['tables'][0])
			return true;
		if("rangocalificacion" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("lasierra_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("docente" == $this->chrt_array['tables'][0])
			return true;
		if("docente" == $this->chrt_array['tables'][0])
