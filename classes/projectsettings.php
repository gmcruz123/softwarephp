...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("docente", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "docente" ] = array( "url" => "docente", "type" => 0 );
	$projectEntitiesReverse[ "docente" ] = "docente";
	$projectEntities[ "estado" ] = array( "url" => "estado", "type" => 0 );
	$projectEntitiesReverse[ "estado" ] = "estado";
	$projectEntities[ "asignatura" ] = array( "url" => "asignatura", "type" => 0 );
	$projectEntitiesReverse[ "asignatura" ] = "asignatura";
	$projectEntities[ "profesion" ] = array( "url" => "profesion", "type" => 0 );
	$projectEntitiesReverse[ "profesion" ] = "profesion";
	$projectEntities[ "estudiantes" ] = array( "url" => "estudiantes", "type" => 0 );
	$projectEntitiesReverse[ "estudiantes" ] = "estudiantes";
	$projectEntities[ "habilidades" ] = array( "url" => "habilidades", "type" => 0 );
	$projectEntitiesReverse[ "habilidades" ] = "habilidades";
	$projectEntities[ "Reporte de Estudiantes" ] = array( "url" => "Reporte_de_Estudiantes", "type" => 2 );
	$projectEntitiesReverse[ "Reporte_de_Estudiantes" ] = "Reporte de Estudiantes";
	$projectEntities[ "usuarios" ] = array( "url" => "usuarios", "type" => 0 );
	$projectEntitiesReverse[ "usuarios" ] = "usuarios";
	$projectEntities[ "roles" ] = array( "url" => "roles", "type" => 0 );
	$projectEntitiesReverse[ "roles" ] = "roles";
	$projectEntities[ "Quienes Somos" ] = array( "url" => "Quienes_Somos", "type" => 4 );
	$projectEntitiesReverse[ "Quienes_Somos" ] = "Quienes Somos";
	$projectEntities[ "PROYECTOS" ] = array( "url" => "PROYECTOS", "type" => 4 );
	$projectEntitiesReverse[ "PROYECTOS" ] = "PROYECTOS";
	$projectEntities[ "PIAR" ] = array( "url" => "PIAR", "type" => 4 );
	$projectEntitiesReverse[ "PIAR" ] = "PIAR";
	$projectEntities[ "PERFILDOCENTE" ] = array( "url" => "PERFILDOCENTE", "type" => 1 );
	$projectEntitiesReverse[ "PERFILDOCENTE" ] = "PERFILDOCENTE";
	$projectEntities[ "ESTUDIANTESACARGO" ] = array( "url" => "ESTUDIANTESACARGO", "type" => 1 );
	$projectEntitiesReverse[ "ESTUDIANTESACARGO" ] = "ESTUDIANTESACARGO";
	$projectEntities[ "Estadisticas de Estudiantes" ] = array( "url" => "Estadisticas_de_Estudiantes", "type" => 2 );
	$projectEntitiesReverse[ "Estadisticas_de_Estudiantes" ] = "Estadisticas de Estudiantes";
	$projectEntities[ "miscasos" ] = array( "url" => "miscasos", "type" => 0 );
	$projectEntitiesReverse[ "miscasos" ] = "miscasos";
	$projectEntities[ "seguimiento" ] = array( "url" => "seguimiento", "type" => 0 );
	$projectEntitiesReverse[ "seguimiento" ] = "seguimiento";
	$projectEntities[ "preguntas" ] = array( "url" => "preguntas", "type" => 0 );
	$projectEntitiesReverse[ "preguntas" ] = "preguntas";
	$projectEntities[ "rangocalificacion" ] = array( "url" => "rangocalificacion", "type" => 0 );
	$projectEntitiesReverse[ "rangocalificacion" ] = "rangocalificacion";
	$projectEntities[ "Dicccionario" ] = array( "url" => "Dicccionario", "type" => 4 );
	$projectEntitiesReverse[ "Dicccionario" ] = "Dicccionario";
