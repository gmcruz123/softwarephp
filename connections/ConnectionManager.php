...
class ConnectionManager
{
	...
	{
		return $this->byId( "lasierra_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "lasierra_at_localhost";
		$data["connName"] = "lasierra at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;lasierra;;1"; //currently unused

		$this->_connectionsIdByName["lasierra at localhost"] = "lasierra_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "lasierra";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=lasierra;OPTION=3";
		// encription set
		...
		$connectionsData["lasierra_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["docente"] = "lasierra_at_localhost";
		$connectionsIds["estado"] = "lasierra_at_localhost";
		$connectionsIds["asignatura"] = "lasierra_at_localhost";
		$connectionsIds["profesion"] = "lasierra_at_localhost";
		$connectionsIds["estudiantes"] = "lasierra_at_localhost";
		$connectionsIds["habilidades"] = "lasierra_at_localhost";
		$connectionsIds["Reporte de Estudiantes"] = "lasierra_at_localhost";
		$connectionsIds["usuarios"] = "lasierra_at_localhost";
		$connectionsIds["roles"] = "lasierra_at_localhost";
		$connectionsIds["PERFILDOCENTE"] = "lasierra_at_localhost";
		$connectionsIds["ESTUDIANTESACARGO"] = "lasierra_at_localhost";
		$connectionsIds["Estadisticas de Estudiantes"] = "lasierra_at_localhost";
		$connectionsIds["miscasos"] = "lasierra_at_localhost";
		$connectionsIds["seguimiento"] = "lasierra_at_localhost";
		$connectionsIds["preguntas"] = "lasierra_at_localhost";
		$connectionsIds["rangocalificacion"] = "lasierra_at_localhost";
		$connectionsIds["admin_rights"] = "lasierra_at_localhost";
		$connectionsIds["admin_members"] = "lasierra_at_localhost";
		$connectionsIds["admin_users"] = "lasierra_at_localhost";
