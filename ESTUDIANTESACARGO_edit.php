...
require_once("include/ESTUDIANTESACARGO_variables.php");
...
$layout = new TLayout("edit_bootstrap_4col", "DeliciousOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "ESTUDIANTESACARGO_edit";
...
$page_layouts["ESTUDIANTESACARGO_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "ESTUDIANTESACARGO_list";
...
$page_layouts["ESTUDIANTESACARGO_list"] = $layout;
...
$layout = new TLayout("tab_bootstrap", "DeliciousOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "ESTUDIANTESACARGO_edit_Step1";
...
$page_layouts["ESTUDIANTESACARGO_edit_Step1"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "ESTUDIANTESACARGO_edit_Step2";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bstabfields",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["ESTUDIANTESACARGO_edit_Step2"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "ESTUDIANTESACARGO_edit_DIMENSION_COGNOCITIVA1";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bstabfields",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["ESTUDIANTESACARGO_edit_DIMENSION_COGNOCITIVA1"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "ESTUDIANTESACARGO_edit_Psicomotriz_Corporal1";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bstabfields",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["ESTUDIANTESACARGO_edit_Psicomotriz_Corporal1"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "ESTUDIANTESACARGO_edit_Artistica1";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bstabfields",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["ESTUDIANTESACARGO_edit_Artistica1"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "ESTUDIANTESACARGO_edit_Socio_Afectiva1";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bstabfields",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["ESTUDIANTESACARGO_edit_Socio_Afectiva1"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "ESTUDIANTESACARGO_edit_Comportamental_y_Diciplinaria1";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bstabfields",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["ESTUDIANTESACARGO_edit_Comportamental_y_Diciplinaria1"] = $layout;
...
$keys = array();
$keys["ID_ESTUDIANTE"] = postvalue("editid1");
