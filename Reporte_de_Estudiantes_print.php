...
require_once("include/Reporte_de_Estudiantes_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "Reporte_de_Estudiantes_rprint";
...
$page_layouts["Reporte_de_Estudiantes_rprint"] = $layout;
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Reporte_de_Estudiantes.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
