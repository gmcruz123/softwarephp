...
require_once("include/Estadisticas_de_Estudiantes_variables.php");
...
$layout = new TLayout("rprint_bootstrap", "DeliciousOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "Estadisticas_de_Estudiantes_rprint";
...
$page_layouts["Estadisticas_de_Estudiantes_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Estadisticas_de_Estudiantes.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Estadisticas_de_Estudiantes.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
