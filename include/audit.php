...
class AuditTrailTable
{
	...
	function logValueEnable($table)
	{
		...
		if($table=="habilidades")
		{
			return false;
		}
		if($table=="Reporte de Estudiantes")
		{
			return false;
		}
		if($table=="usuarios")
		...
		if($table=="PERFILDOCENTE")
		{
			return false;
		}
		if($table=="ESTUDIANTESACARGO")
		{
			return false;
		}
		if($table=="Estadisticas de Estudiantes")
		{
			return false;
		}
		if($table=="miscasos")
		...
		if($table=="rangocalificacion")
		{
			return false;
		}
		if($table=="Dicccionario")
		{
			return false;
		}
