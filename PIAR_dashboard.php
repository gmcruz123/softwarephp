...
require_once("include/PIAR_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "PIAR_dashboard";
...
$page_layouts["PIAR_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("PIAR", "dashboard");
